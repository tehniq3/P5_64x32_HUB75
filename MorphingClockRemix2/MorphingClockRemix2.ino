 ...
 * ver.1.l.3.b - removed OTA due year issue
 * ver.2.0 - added DST switch (A0 to GND -> DST = 0, A0 to 3.3V -> DST = 1)
*/
...
#include <PxMatrix.h>  // version=1.3.0 - https://www.arduinolibraries.info/libraries/px-matrix-led-matrix-library
...
void wifi_setup ()
{
  ...
  display.setTextColor (display.color565 (0, 0, cin));
    ...
    TFDrawText (&display, String("    ver. 2.0    "), 0, 20, display.color565(cin, 0, cin));
    delay(3000);
    display.fillScreen (display.color565 (0, 0, 0));
...
// ca55295c4a1dce2688e0751d4b9a68de
