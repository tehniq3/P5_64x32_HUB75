...
*/
    ...
    TFDrawText (&display, String(wifiManagerAPName), 15, 0, display.color565(0, 0, 255));
    TFDrawText (&display, String("Pw:"), 0, 10, display.color565(0, 0, 255));
    TFDrawText (&display, String(wifiManagerAPPassword), 15, 10, display.color565(0, 0, 255));
    TFDrawText (&display, String("IP:"), 0, 20, display.color565(0, 0, 255));
    TFDrawText (&display, String("192.168.4.1"), 10, 20, display.color565(0, 0, 255));
...
String apiKey   = "2berierecipentruniq_ro!"; //e.g a hex string like "abcdef0123456789abcdef0123456789"
