...
void wifi_setup ()
{
  ...
  display.setTextColor (display.color565 (0, 0, cin));
    ...
    TFDrawText (&display, String("   ver. 1.l     "), 0, 20, display.color565(cin, 0, cin));
    delay(3000);
    display.fillScreen (display.color565 (0, 0, 0));
...
String apiKey   = "niq_rodeserve2-3(few)beers"; //e.g a hex string like "abcdef0123456789abcdef0123456789"
...
int cloudyn_ico [50] = {
  ...
  0x0000, 0x0000, 0x0000, 0x0000, 0xffe0, 0xffff, 0xffff, 0xffff, 0xffff, 0x0000,
...
int cloudy1n_ico [50] = {
  ...
  0x0000, 0x0000, 0x0000, 0x0000, 0xffe0, 0xffe0, 0xffff, 0xffff, 0xffff, 0xffff,
...
int cloudy2n_ico [50] = {
  ...
  0xffff, 0x0000, 0x0000, 0x0000, 0xffe0, 0xffe0, 0x0000, 0xffff, 0xffff, 0xffff,
...
int cloudy3n_ico [50] = {
  ...
  0xffff, 0xffff, 0x0000, 0x0000, 0xffe0, 0xffe0, 0x0000, 0x0000, 0xffff, 0xffff,
...
int cloudy4n_ico [50] = {
  ...
  0xffff, 0xffff, 0xffff, 0x0000, 0xffe0, 0xffe0, 0x0000, 0x0000, 0x0000, 0xffff,
...
int cloudy5n_ico [50] = {
  ...
  0xffff, 0xffff, 0xffff, 0xffff, 0xffe0, 0xffe0, 0x0000, 0x0000, 0x0000, 0x0000,
