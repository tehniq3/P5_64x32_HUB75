 ...
 * ver.1.h2 - small correcion for clear zone :)
...
void wifi_setup ()
{
  ...
  display.setTextColor (display.color565 (0, 0, cin));
    ...
    TFDrawText (&display, String(" MORPHING CLOCK "), 0, 13, display.color565(0, 0, cin));
  //  TFDrawText (&display, String(" REMIX ver. 1.h "), 0, 20, display.color565(cin, cin, 0));
    TFDrawText (&display, String("niq_ro's rem~ix "), 0, 20, display.color565(cin, cin, 0));
    delay(3000);
    display.fillScreen (display.color565 (0, 0, 0));
...
*/
    ...
    TFDrawText (&display, String("192.168.4.1"), 10, 20, display.color565(cin, 0, cin));
...
String apiKey   = "1spritzrececuvindemisec"; //e.g a hex string like "abcdef0123456789abcdef0123456789"
