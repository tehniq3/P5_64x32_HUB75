...
Stable schematic (D3/GPIO0 not conected to E (not used but connected to GND) and ESP8266 fails to boot, see https://randomnerdtutorials.com/esp8266-pinout-reference-gpios/ .
